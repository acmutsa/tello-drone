...
parser.add_argument('--body_cascade', help='Path to body cascade.', default='/usr/local/lib/python3.8/site-packages/cv2/data/haarcascade_fullbody.xml')
# parser.add_argument('--device', help='Path camera.', type=str, default='/dev/video0')
